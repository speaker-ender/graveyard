...
//         // Literallly logging everything to try and find exactly where the issue is
//         console.log(constants.ZERO_ADDRESS);
//         console.log(this.deadCoin.transfer);
//         console.log(this.knownValue.toString());
//         console.log(sender);

//         // Seems to be an issue with the transfer function....
